...
Add the following folders to the matlab path: "threeDAxis", "twoD", "inpolyhedron", "stl",
"stlread".
...
To visualise the results, first add the "visualtisationFunctions3D" folder to the matlab 
path.
...
You may wish to load one of the workspace files from the "simulationTestOutputs" folder.
