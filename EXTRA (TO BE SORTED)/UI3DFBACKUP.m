...
[object2.vertices, object2.faces] = stlread('R:\projects\nowlan_group_data\live\James\morishita2021\EndG\GROUP11\10.4R\10.4RG.stl');
...
b5.Callback = "dataStruct.transPre = getappdata(f,'transformPre');dataStruct.transRot = getappdata(f,'transformRot')";
